...
export default function CakePackages({
    packages,
                ...
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        ...
                        <h1 className="text-2xl font-black tracking-tight text-zinc-900 flex items-center gap-3">
                            <PackageCheck className="size-8 text-[#F57C00]" />
                            Cake Packages
                        </h1>
                        <p className="text-sm font-medium text-zinc-500">Manage your catalog of cake packages and pricing.</p>
                    </div>
