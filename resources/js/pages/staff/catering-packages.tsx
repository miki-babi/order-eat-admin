                    ...
                    {canManagePackages && (
                        <Dialog open={isCreateModalOpen} onOpenChange={setIsCreateModalOpen}>
                            <DialogTrigger asChild>
                                <Button className="h-12 rounded-xl bg-primary text-white hover:bg-primary/90 font-bold px-6 shadow-lg shadow-primary/20 gap-2">
                                ...
                                <form className="p-6 space-y-6" onSubmit={createPackage}>
                                    ...
                                    <div className="flex items-center justify-between rounded-2xl border border-zinc-100 bg-zinc-50/50 px-5 py-4">
                                        ...
                                        <div className="flex gap-3">
                                            <Button type="button" variant="ghost" className="rounded-xl font-bold text-zinc-500 hover:bg-primary" onClick={() => setIsCreateModalOpen(false)}>
                                                Cancel
                                            </Button>
