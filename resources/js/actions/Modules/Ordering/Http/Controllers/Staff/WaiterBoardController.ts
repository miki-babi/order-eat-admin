...
/**
* @see \Modules\Ordering\Http\Controllers\Staff\WaiterBoardController::updateCustomerTags
...
*/
export const updateCustomerTags = (args: { order: string | number | { id: string | number } } | [order: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteDefinition<'patch'> => ({
    url: updateCustomerTags.url(args, options),
    method: 'patch',
})

updateCustomerTags.definition = {
    methods: ["patch"],
...
* @route '/staff/waiter-board/orders/{order}/customer-tags'
*/
updateCustomerTags.url = (args: { order: string | number | { id: string | number } } | [order: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { order: args }
    }
    ...
    return updateCustomerTags.definition.url
            .replace('{order}', parsedArgs.order.toString())
            .replace(/\/+$/, '') + queryParams(options)
}
...
* @route '/staff/waiter-board/orders/{order}/customer-tags'
*/
updateCustomerTags.patch = (args: { order: string | number | { id: string | number } } | [order: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteDefinition<'patch'> => ({
    url: updateCustomerTags.url(args, options),
    method: 'patch',
})
...
* @route '/staff/waiter-board/orders/{order}/customer-tags'
*/
const updateCustomerTagsForm = (args: { order: string | number | { id: string | number } } | [order: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: updateCustomerTags.url(args, {
        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
            _method: 'PATCH',
            ...(options?.query ?? options?.mergeQuery ?? {}),
        }
...
* @route '/staff/waiter-board/orders/{order}/customer-tags'
*/
updateCustomerTagsForm.patch = (args: { order: string | number | { id: string | number } } | [order: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: updateCustomerTags.url(args, {
        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
            _method: 'PATCH',
            ...(options?.query ?? options?.mergeQuery ?? {}),
...
updateCustomerTags.form = updateCustomerTagsForm

const WaiterBoardController = { index, confirm, serve, updateCustomerTags }

export default WaiterBoardController