...
// node_modules/react-photo-sphere-viewer/dist/_virtual/_rollupPluginBabelHelpers.js
...
// node_modules/react-photo-sphere-viewer/dist/index.js
var import_react = __toESM(require_react());
import "/home/miki/digital order/alx/kds-rc/node_modules/@photo-sphere-viewer/core/index.css";

// node_modules/react-photo-sphere-viewer/dist/_virtual/_commonjsHelpers.js
function getDefaultExportFromCjs(x) {
  return x && x.__esModule && Object.prototype.hasOwnProperty.call(x, "default") ? x["default"] : x;
}

// node_modules/react-photo-sphere-viewer/dist/_virtual/index.js
var eventemitter3 = { exports: {} };

// node_modules/react-photo-sphere-viewer/dist/node_modules/eventemitter3/index.js
(function(module) {
...
var omittedProps = ["src", "height", "width", "hideNavbarButton", "containerClass", "littlePlanet", "onPositionChange", "onZoomChange", "onClick", "onDblclick", "onReady"];
var defaultNavbar = ["zoom", "fullscreen"];
function adaptOptions(options) {
  var adaptedOptions = _objectSpread2({}, options);
...
function useDomElement() {
  var _useState = (0, import_react.useState)(), _useState2 = _slicedToArray(_useState, 2), element = _useState2[0], setElement = _useState2[1];
  var ref = (0, import_react.useCallback)(function(r) {
    if (r && r !== element) {
      setElement(r);
    }
  }, [element]);
...
var ReactPhotoSphereViewer = (0, import_react.forwardRef)(function(props, ref) {
  var _useDomElement = useDomElement(), _useDomElement2 = _slicedToArray(_useDomElement, 2), sphereElement = _useDomElement2[0], setRef = _useDomElement2[1];
  ...
  var spherePlayerInstance = (0, import_react.useRef)(null);
  var LITTLEPLANET_MAX_ZOOM = 130;
  var _useState3 = (0, import_react.useState)(-90), _useState4 = _slicedToArray(_useState3, 1), LITTLEPLANET_DEF_LAT = _useState4[0];
  var _useState5 = (0, import_react.useState)(2), _useState6 = _slicedToArray(_useState5, 1), LITTLEPLANET_FISHEYE = _useState6[0];
  var _useState7 = (0, import_react.useState)(0), _useState8 = _slicedToArray(_useState7, 1), LITTLEPLANET_DEF_ZOOM = _useState8[0];
  var _useState9 = (0, import_react.useState)(defaultNavbar), _useState10 = _slicedToArray(_useState9, 2), currentNavbar = _useState10[0], setCurrentNavbar = _useState10[1];
  var littlePlanetEnabledRef = (0, import_react.useRef)(true);
  ...
  (0, import_react.useEffect)(function() {
    if (sphereElement && !spherePlayerInstance.current) {
      ...
      var _c = new Viewer(_objectSpread2(_objectSpread2({}, adaptOptions(options)), {}, {
        ...
        panoData: options.panoData || void 0,
        requestHeaders: options.requestHeaders || void 0,
      ...
      if (options.littlePlanet) {
        ...
        if (_currentNavbar !== false && !_currentNavbar.find(function(item) {
          return _typeof(item) === "object" && (item === null || item === void 0 ? void 0 : item.id) === "resetLittlePlanetButton";
        })) {
      ...
      if (options.hideNavbarButton) {
        ...
        if (_currentNavbar !== false && !_currentNavbar.find(function(item) {
          return _typeof(item) === "object" && (item === null || item === void 0 ? void 0 : item.id) === "hideNavbarButton";
        })) {
      ...
      Emitter.on("animate", function(options2) {
        _c.animate(options2);
      }).on("stop-animation", function() {
        _c.stopAnimation();
      }).on("destroy", function() {
        _c.destroy();
      }).on("rotate", function(options2) {
        _c.rotate(options2);
      }).on("setOption", function(pair) {
        var option = pair.option, value = pair.value;
        _c.setOption(option, value);
      }).on("setOptions", function(options2) {
        _c.setOptions(options2);
  ...
  var _imperativeHandle = function _imperativeHandle2() {
    return {
      animate: function animate(options2) {
        Emitter.emit("animate", options2);
      },
      ...
      setOptions: function setOptions(options2) {
        ...
        return (_spherePlayerInstance2 = spherePlayerInstance.current) === null || _spherePlayerInstance2 === void 0 ? void 0 : _spherePlayerInstance2.setOptions(options2);
      },
      ...
      setPanorama: function setPanorama(path, options2) {
        var _spherePlayerInstance14;
        return (_spherePlayerInstance14 = spherePlayerInstance.current) === null || _spherePlayerInstance14 === void 0 ? void 0 : _spherePlayerInstance14.setPanorama(path, options2);
      },
  ...
  (0, import_react.useImperativeHandle)(ref, _imperativeHandle, [spherePlayerInstance.current, sphereElement, options, ref]);
...
//# sourceMappingURL=react-photo-sphere-viewer.js.map
